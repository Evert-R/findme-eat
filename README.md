...
6. As a user who searches locally I also want to be able to see how far away restaurant is from me in the search reesults. I also want to be able to see where I am on the resultsmap 
...
- [Javascript flowchart](UXD/javascript-flowchart.jpg)
